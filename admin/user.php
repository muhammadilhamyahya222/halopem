        ...
        <table class="display responsive-table" style="width:100%">
          <thead>
              <tr style="background-color: #8FBC8F;">
				...
				<th class="white-text">Telephone</th>
				<th class="white-text">Level</th>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn yellow black-text teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="red btn" onclick="return confirm('Hapus user?')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
