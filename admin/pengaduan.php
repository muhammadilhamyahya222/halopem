        ...
        <table class="display responsive-table" style="width:100%">
          <thead>
              <tr style="background-color: #8FBC8F;">
				...
				<th class="white-text">Isi Laporan</th>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn modal-trigger blue" href="#more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a>  <a class="btn red" onclick="return confirm('Hapus pengaduan?')" href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a></td>
